...
/*
  ...
  ====================
  ver 4.0 : 10 Mar 2017
  - added rules for enum, typedef, and alias
  ver 3.2 : 29 Oct 2016
...
namespace CodeAnalysis
{
  ...
  private:
	...
	HandleEnumDefinition* pHandleEnumDefinition = nullptr;//handle enum

	TypedefDefinition* pTypedefDefinition = nullptr;
	HandleTypedefDefinition* pHandleTypedefDefinition = nullptr;//handle typedef

	AliasDefinition* pAliasDefinition = nullptr;
	HandleAliasDefinition* pHandleAliasDefinition = nullptr;//handle alias
