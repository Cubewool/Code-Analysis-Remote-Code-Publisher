...
ConfigParseForCodeAnal::~ConfigParseForCodeAnal()
{
  ...
  delete pHandleEnumDefinition;//enum
  delete pEnumDefinition;

  delete pHandleTypedefDefinition;//typedef
  delete pTypedefDefinition;

  delete pHandleAliasDefinition;//alias
...
Parser* ConfigParseForCodeAnal::Build()
{
  try
  {
	...
	pParser->addRule(pTypedefDefinition);//typedef 
	...
	pParser->addRule(pAliasDefinition);//alias
